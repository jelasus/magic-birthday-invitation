...
export default async function InvitePage({ searchParams }: InvitePageProps) {
  ...
  return (
    ...
    >
      <h1 className="text-4xl font-black text-amber-400 mb-1 text-center tracking-wide drop-shadow-lg">
        ¡Estás invitado!
      </h1>
      <p className="text-amber-200 mb-8 text-sm text-center italic">
